...
def get_dir_index(args):
    dir, index, lang = "", "", ""  # if question_number is in Roman, how to fix
    try:
        optlist, args = getopt.getopt(args, "hd:i:l:", ["help", "dir=", "index=", "lang="])
    ...
    return dir, index, lang, args


if __name__ == "__main__":
    args = sys.argv[1:]
    dir, index, lang, args = get_dir_index(args)
    index = " ".join([index.strip()] + args)
    # get template path
    path = create_note_content(dir, index, lang)
